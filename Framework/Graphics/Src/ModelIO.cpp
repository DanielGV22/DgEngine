...
void DgEngine::Graphics::ModelIO::SaveModel(std::filesystem::path filePath, const Model& model)
{
...
void DgEngine::Graphics::ModelIO::LoadModel(std::filesystem::path filePath, Model& model)
{
	filePath.replace_extension("model");
...
void DgEngine::Graphics::ModelIO::SaveMaterial(std::filesystem::path filePath, const Model& material)
{

}

void DgEngine::Graphics::ModelIO::LoadMaterial(std::filesystem::path filePath, Model& material)
{
